...
class LiamW_PostMacros_Extend_ViewPublic_Conversation_Reply extends XFCP_LiamW_PostMacros_Extend_ViewPublic_Conversation_Reply
{
...
if (false)
{
	class XFCP_LiamW_PostMacros_Extend_ViewPublic_Conversation_Reply extends XenForo_ViewPublic_Conversation_Reply
	{
	}
}