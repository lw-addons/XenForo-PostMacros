...
class LiamW_PostMacros_Extend_ViewPublic_Thread_View extends XFCP_LiamW_PostMacros_Extend_ViewPublic_Thread_View
{
...
if (false)
{
	class XFCP_LiamW_PostMacros_Extend_ViewPublic_Thread_View extends XenForo_ViewPublic_Thread_View
	{
	}
}