...
class LiamW_PostMacros_Extend_ViewPublic_Thread_Reply extends XFCP_LiamW_PostMacros_Extend_ViewPublic_Thread_Reply
{
...
if (false)
{
	class XFCP_LiamW_PostMacros_Extend_ViewPublic_Thread_Reply extends XenForo_ViewPublic_Thread_Reply
	{
	}
}