...
class LiamW_Macros_Extend_ViewPublic_Conversation_View extends XFCP_LiamW_Macros_Extend_ViewPublic_Conversation_View
{
	public function renderHtml()
	{
		...
		if ($userId)
		{
			...
			$show = !$macrosModel->hiddenOnConversationQuickReply($userId);
...
if (false)
{
	class XFCP_LiamW_Macros_Extend_ViewPublic_Conversation_View extends XenForo_ViewPublic_Conversation_View
	{
	}
}